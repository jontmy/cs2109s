...
\emph{In essence, a tree search simulates the exploration of the state space by generating sucessors of already-explored states, starting from the initial state.}
